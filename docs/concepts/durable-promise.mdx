...
- [Python SDK quickstart - Part 2 Durable Execution](/get-started/python-quickstart#part-2-crash-recovery)
- [TypeScript SDK quickstart - Part 2 Durable Execution](/get-started/typescript-quickstart#part-2-crash-recovery)
