...
title: Resonate HQ Server installation
sidebar_label: Server installation
description: Learn how to install and run the Resonate HQ Server on your machine.
last_update:
  date: "08-21-2024"
...
Install and run the Resonate HQ Server to provide durability to your application through hard crashes and failures.
