...
In [Part 1](/get-started/typescript-quickstart/part-1), you develop your first _Distributed Async Await_ application with the Resonate SDK, a summarization service.
...
In [Part 2](/get-started/typescript-quickstart/part-2), you connect your application to a Resonate Server to enable recovery from platform-level failures.
