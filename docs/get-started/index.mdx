---
id: index
title: Get started with Resonate HQ
...
Resonate HQ currently has a [TypeScript SDK](/develop/typescript) and a [Python SDK](/develop/python).
...
### Step 4. Connect to a Resonate HQ Server
...
See the [Install and run the Resonate HQ Server](/get-started/server-installation) guide for details.
