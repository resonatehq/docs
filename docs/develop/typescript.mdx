...
If you are new to Resonate, we recommend following the **[Resonate TypeScript SDK quickstart tutorial](/get-started/typescript-quickstart)** to get started learning how to use Resonate. 🚀
